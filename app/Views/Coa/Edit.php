  ...
  <div class="main-content">
      <section class="section">
          ...
          <form class="row g-3" action="<?= base_url('coa/update') ?>" method="post">
              <?= csrf_field() ?>
              <div class="col-12">
                  <label for="kode_akun" class="col-md-4 col-form-label">Kode Akun</label>
                  <div class="col-md-10">
                      <input type="text" id="kode_akun" name="kode_akun" class="form-control" value="<?= $kode_akun ?>" readonly>
                  </div>
              </div>
              <div class="col-12">
                  ...
                  <div class="col-md-10">
                      <?php
                        ...
                        ?>
                      <input type="text" class="form-control" id="nama_akun" name="nama_akun" value="<?= $nama_akun ?>" placeholder="Masukkan Nama Akun">
              ...
              <div class="col-12">
                  ...
                  <div class="col-md-10">
                      <?php
                        ...
                        ?>
                      <input type="text" class="form-control" id="header_akun" name="header_akun" value="<?= $header_akun ?>" placeholder="Masukkan Header Akun">
                  </div>
                  <br>
                  <div class="col-md-4">
                      <div class="col-md-2"></div>
                      <input class="col-md-4 btn btn-info" type="submit" value="Ubah">
