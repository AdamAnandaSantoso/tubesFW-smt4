            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">Sistem Informasi RS</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="nav-link" href="http://localhost:8080/Stisla/index"><i class="fas fa-book"></i><span>COA</span></a></li>
                        <li><a class="nav-link" href="http://localhost:8080/Stisla/index"><i class="fas fa-bed"></i><span>Pasien</span></a></li>
                        <li><a class="nav-link" href="http://localhost:8080/Stisla/index"><i class="fas fa-user-nurse"></i><span>Petugas</span></a></li>
                        <li><a class="nav-link" href="http://localhost:8080/Stisla/index"><i class="fas fa-door-closed"></i><span>Kamar</span></a></li>
                        <li><a class="nav-link" href="http://localhost:8080/Stisla/index"><i class="fas fa-archway"></i><span>Jenis Kamar</span></a></li>
